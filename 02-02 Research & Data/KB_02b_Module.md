...
This rule exists because the Narrative Report becomes the baseline for the entire cycle. Agent 06 will compare the narrative space after the hack against this baseline to measure impact. If the baseline contains invented or unsourced claims, the impact evaluation has no foundation.
...
Standard is 5 per community. The practitioner can request more at any time — see `KB_02b_Prompting.md`.

### Step 6 — Produce the three outputs
See `KB_02b_Actions.md` for all templates. Produce in order:
