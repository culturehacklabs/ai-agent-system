...
Standard is 5 entries per community. The practitioner can request more at any time — see `KB_02b_Prompting.md`.
...
*To request additional entries for a specific community, see `KB_02b_Prompting.md`.*
